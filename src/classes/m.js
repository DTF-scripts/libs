const El = {
  ...
  Button: function({path, cName, id, title, text, label, container, style, onclick, disabled, rtn}){
  ...
  A: function({path, text, url, cName, id, onclick, rtn}){
  ...
  Input: function({path, container, type, cName, lName, lAttr, name, id, text, datalist, label, title, value, autocomplete, list, accepted, pattern, placeholder, min, max, step, checked, disabled, required, auto, onclick, onchange, onfocus, onblur, onpaste, onRclick, onkeydown, onkeyup, style, rtn}){
